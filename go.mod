module github.com/vul-os/vulos-meet

go 1.26

// The shared Vulos Apps & Bots platform is developed in lockstep with the
// products that host it; consume it from the sibling checkout.
